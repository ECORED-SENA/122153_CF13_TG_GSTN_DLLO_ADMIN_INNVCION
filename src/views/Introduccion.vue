    ...
    figure
      .video
        iframe(
          width='560',
          height='315',
          src='https://www.youtube.com/embed/b7Jt97XMGqM',
          title='YouTube video player',
          frameborder='0',
          allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture',
          allowfullscreen
        )
    figcaption Video. Archivos y valoración documental - Introducción
